...
VALIDATION_MAX_ATTEMPTS = max(
    1, int(os.getenv("VALIDATION_MAX_ATTEMPTS", "1"))
)
...
TELEGRAM_FEEDBACK_POLL_SECONDS = max(
    2, int(os.getenv("TELEGRAM_FEEDBACK_POLL_SECONDS", "5"))
)
...
THREADS_TOKEN_RECORD = os.getenv("THREADS_TOKEN_RECORD", "").strip()
...
THREADS_RENDER_ENV_KEY = (
    os.getenv("THREADS_RENDER_ENV_KEY", "THREADS_TOKEN_RECORD").strip()
    or "THREADS_TOKEN_RECORD"
)
